...
url = "https://api-mobile.airfranceklm.com/mobile/offers/v2/available-offers"
token = "Bearer kh6f5zbxp8q8qb58a3vk5d4e"
...
for i in range(1):
    ...
    with open("AirFrance/AF_allOffer.json", "r+") as jsonFile:
        ...
        jsonFile.truncate()
        jsonFile.close()
    body = open('AirFrance/AF_allOffer.json')
    body = body.read()
    try:
